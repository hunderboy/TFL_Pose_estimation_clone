...
//        Log.e(TAG,"왼쪽 무릎 각도 : $degree")
     ...
     */
    fun checkLeftWaistDegree(newXY : XYdata) : Double{
        val paramY_leftWaist = newXY.rightShoulder_y - newXY.rightHip_y
        val paramX_leftWaist = newXY.rightShoulder_x - newXY.rightHip_x
...
//        Log.e(TAG,"왼쪽 허리각 각도 반전 : $degreeReverse_leftWaist")
        ...
        return degreeReverse_leftWaist
...
//          }
     ...
     * 이동하는 점 = leftShoulder
     */
    fun checkRightWaistDegree(newXY : XYdata) : Double{
        val paramY_rightWaist = newXY.leftShoulder_y - newXY.leftHip_y
        val paramX_rightWaist = newXY.leftShoulder_x - newXY.leftHip_x
...
//        Log.e(TAG,"오른쪽 허리각 각도 반전 : $degreeReverse_rightWaist")
        ...
        return degreeReverse_rightWaist
    }
